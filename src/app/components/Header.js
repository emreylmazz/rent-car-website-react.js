  ...
  return (
    ...
    fixed w-full max-w-[1920px] mx-auto z-20 transition-all duration-300`}>
        ...
        <div className="flex justify-between items-center px-4">
          ...
          <Image src={'/public/assets/assets/icons/logo.jpg'} width={194} height={64} alt="" />
            </Link>
            {/*  nav open menu */}
        ...
        xl:font-medium xl:flex-row xl:w-max xl:gap-x-8 xl:h-max xl:bg-tansparent xl:pb-0
         transition-all duration-150 text-center xl:text-left uppercase text-sm xl:text-[15px] xl:normal-case`}>
            <Link
            className="cursor-pointer"
            to="home"
            activeClass="active"
