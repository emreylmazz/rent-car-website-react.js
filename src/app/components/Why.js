  ...
  return (
    <section className='section flex items-center bg-green-200' id='why'>
      <div className='container mx-auto'>
        ...
        Unmatched excellence and customer satisfaction</motion.h2>
        <motion.p
         variants={fadeIn('up', 0.4)} 
         initial="hidden" 
         whileInView={"show"}
         viewport={{once:false, amount:0.6}}
        className='max-w-[680px] text-center mx-auto mb-2'>Our dedication to providing expectional services sets us apart from
          the competition. From the moment you engage with us, we strive to exceed your expectations in every interaction.
        </motion.p>
        {/* car image */}
        <motion.div 
        ...
        className='hidden md:flex justify-center mb-6 xl:mb-2'>
          <Image src={'/public/assets/assets/images/why/car.jpg'} width={1060} height={420} alt='' />
        </motion.div>
        {/* grid items */}
        <motion.div 
        ...
        className='flex flex-wrap justify-center xl:grid xl:grif-cols-3 gap-4
