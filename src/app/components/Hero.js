...
<div className='container mx-auto h-full xl:pt-10'>
 ...
 xl:justify-start h-full'>
  ...
  <div className='text-center xl:max-w-xl xl:text-left mt-16 xl:mt-0'>
    ...
    className='h1'>
    <h1>Explore the Finest <span className='text-accent'>Global</span>Offers</h1>
    </motion.h1>
    <motion.p 
  ...
  className='flex gap-x-3 justify-center xl:justify-start'>
    ...
    <button className='btn-cta'>
      <Image src={'/public/assets/assets/icons/buttons/app-store.jpg'}
       width={132}
       height={36}
       alt=''
       />
...
{/* btn google */}
    <button className='btn-cta'>
      <Image src={'/public/assets/assets/icons/buttons/google-play.jpg'}
       width={132}
       height={36}
       alt=''
       />
  ...
  right-[120px] xl:top-48'>
    <Image
     src={'/public/assets/assets/images/hero/car.jpg'}
     fill
     alt=''
