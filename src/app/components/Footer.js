      ...
      <div className="container mx-auto mb-24">
        ...
        gap-y-14"> 
          <div className="flex flex-col flex-1 gap-y-8">
            ...
            <Image src={'/public/assets/assets/icons/logo.jpg'} width={200} height={200} alt=""/>
            </Link>
            {/* text */}
            <div className="text-secondary">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sit, aperiam.</div>
         {/* phone & mail */}
...
<div className="mb-9 text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam, neque!</div>
{/* form */}
