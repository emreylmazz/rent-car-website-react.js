...
const About = () => {
      ...
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row xl:justify-between">
          ...
          className="flex-1 mb-8 xl:mb-0" >
            ...
            src={'/public/assets/assets/images/about/car01.jpg'}
            width={600}
            height={448}
            alt=""
            />
          ...
          <div className="flex-1 flex items-center xl:justify-center">
            <div className="xl:max-w-[517px]">
              ...
              className="mb-[42px] max-w-md">
                Rent, choose, and repair with ease. Our convenient locaitons,
                diverse car types, and reliable repair point ensure a seamless car experience.
              </motion.p>
              {/* stats */}
              <motion.div 
  ...
  <div className="flex flex-col w-[100px]">
                  ...
                  tracking-[2px] text-[13px] max-w-[184px] ">See all cars</motion.button>
                </div>
              </motion.div>
            </div>
          </div>
