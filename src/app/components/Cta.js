...
<div className="container mx-auto">
  <div className="flex flex-col md:flex-row xl:items-center">
    {/* text */}
    <div className="flex-1 xl:mş-24 text-center md:text-left mb-12 md:mb-0">
      <div className="max-w-[520px] mx-auto order-2 xl:order-none">
        ...
        className="flex gap-x-3 justify-center md:justify-start">
          <button className="btn-cta">
            <Image
            src={'/public/assets/assets/icons/buttons/google-play.jpg'}
            width={132}
            height={36}
            alt=""
            />
          ...
          <button className="btn-cta"> 
          <Image
          src={'/public/assets/assets/icons/buttons/app-store.jpg'}
          width={132}
          height={36}
          alt=''
          />
    ...
    className="flex-1 flex justify-center order-1 md:order-none">
      ...
      height={640}
      alt=""
      src={'/public/assets/assets/images/cta/phone.jpg'}/>
    </motion.div>
  </div>
</div>
