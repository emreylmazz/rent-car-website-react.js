...
const testimonialData  = [
  {
    message:
    'They trutly exceeded my expectations and made my car rental experience a delight',
    avatar:'/public/assets/assets/images/testimonial/avatar.jpg',
    name:'Jane Doe',
  ...
  {testimonialData.map((person,index) => {
    ...
    return <SwiperSlide key={index}>
      <div className='flex flex-col justify-center items-center text-center'>
        <FaQuoteLeft className='text-7xl text eccent mb-6'/>
